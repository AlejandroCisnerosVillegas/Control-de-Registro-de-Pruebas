            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                        <h1 class="h3 mb-2 text-gray-800">Registros encontrado con el dato '<?php echo $searchdata;?>' </h1>
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-success">Resultado de los reportes encontrados</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form name="assignto" method="post">
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                where (project_08_patients.FullName like '%$searchdata%' || project_08_patients.MobileNumber like '%$searchdata%' || project_08_testrecord.OrderNumber like '%$searchdata%')
                                                    ");
                                                $cnt=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="patient-report-details.php?tid=<?php echo $row['testid'];?>&&oid=<?php echo $row['OrderNumber'];?>" class="btn btn-success btn-sm" target="blank">Ver Detalles</a> 
                                                    </td>
                                                </tr>
                                                <?php $cnt++;} ?>
                                            </tbody>
